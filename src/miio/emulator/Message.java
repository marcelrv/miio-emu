...
public class Message {
    ...
    public byte[] getMsgData(byte[] data, byte[] deviceID, int timeStamp) throws MiIoCryptoException {
        short msgLength = (short) (data.length + 32);
        ByteBuffer header = ByteBuffer.allocate(16);
        header.put(MAGIC);
        header.putShort(msgLength);
     ...
     * @throws MiIoCryptoException
     */
    public byte[] getRawData() throws MiIoCryptoException {
        return getMsgData(data, deviceId, getTimestampAsInt());
    }
